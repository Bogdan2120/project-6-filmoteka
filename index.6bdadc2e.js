 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ot(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(kt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(St(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ct(t))return"Blackberry";if(Lt(t))return"Webos";if(At(t))return"Safari";if((t.includes("chrome/")||Rt(t))&&!t.includes("edge/"))return"Chrome";if(Nt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=e.match(t);if(2===(null==r?void 0:r.length))return r[1]}return"Other"}function St(e=O()){return/firefox\//i.test(e)}function At(e=O()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Rt(e=O()){return/crios\//i.test(e)}function kt(e=O()){return/iemobile/i.test(e)}function Nt(e=O()){return/android/i.test(e)}function Ct(e=O()){return/blackberry/i.test(e)}function Lt(e=O()){return/webos/i.test(e)}function Pt(e=O()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Ut(){return A()&&10===document.documentMode}function Bt(e=O()){return Pt(e)||Nt(e)||Lt(e)||Ct(e)||/windows phone/i.test(e)||kt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=index.6bdadc2e.js.map
