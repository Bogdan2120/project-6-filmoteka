 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ot(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Rt(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(St(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ct(t))return"Blackberry";if(Lt(t))return"Webos";if(At(t))return"Safari";if((t.includes("chrome/")||kt(t))&&!t.includes("edge/"))return"Chrome";if(Nt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=e.match(t);if(2===(null==r?void 0:r.length))return r[1]}return"Other"}function St(e=O()){return/firefox\//i.test(e)}function At(e=O()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function kt(e=O()){return/crios\//i.test(e)}function Rt(e=O()){return/iemobile/i.test(e)}function Nt(e=O()){return/android/i.test(e)}function Ct(e=O()){return/blackberry/i.test(e)}function Lt(e=O()){return/webos/i.test(e)}function Pt(e=O()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Ut(){return A()&&10===document.documentMode}function Dt(e=O()){return Pt(e)||Nt(e)||Lt(e)||Ct(e)||/windows phone/i.test(e)||Rt(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ht{toJSON(){return Je("not implemented")}_getIdTokenResponse(e){return Je("not implemented")}_linkToIdToken(e,t){return Je("not implemented")}_getReauthenticationResolver(e){return Je("not implemented")}constructor(e,t){this.providerId=e,this.signInMethod=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(o,t),o})(r,n)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,r)=>{e.getProvider("auth-internal").initialize()}))),Ee(new W("auth-internal",(e=>{const t=jt(e.getProvider("auth").getImmediate());return new Fr(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Te(Mr,jr,function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Hr)),Te(Mr,jr,"esm2017");firebase.initializeApp({apiKey:"AIzaSyBAxD1d6Q1iAwziX2Na8ubQZJCLhj-Pvhg",authDomain:"project-b3c7f.firebaseapp.com",databaseURL:"https://project-b3c7f-default-rtdb.europe-west1.firebasedatabase.app",projectId:"project-b3c7f",storageBucket:"project-b3c7f.appspot.com",messagingSenderId:"815844014735",appId:"1:815844014735:web:4184be206f1dcdb43b4efa"});document.getElementById("signin").addEventListener("click",(function(){const e=new firebase.auth.GoogleAuthProvider;firebase.auth().signInWithPopup(e).then((function(e){document.getElementById("signin").classList.add("signOut"),document.getElementById("signout").classList.add("signIn"),document.getElementById("googleUser").style.display="block",function(e){document.getElementById("googleUser").innerHTML=`\n          <img class="user-img" src="${e.user.photoURL}">\n        `}(e)})).catch((function(e){console.log(e)}))})),document.getElementById("signout").addEventListener("click",(function(){firebase.auth().signOut().then((()=>{document.getElementById("signin").classList.remove("signOut"),document.getElementById("signout").classList.remove("signIn"),document.getElementById("googleUser").style.display="none"})).catch((e=>{console.log(e)}))})),new Qt;s("foEof");const Wr=document.querySelector(".btn-to-top");window.addEventListener("scroll",(function(){const e=window.pageYOffset,t=document.documentElement.clientHeight;e>t&&Wr.classList.add("btn-to-top--visible");e<t&&Wr.classList.remove("btn-to-top--visible")})),Wr.addEventListener("click",(function(){window.pageYOffset>0&&window.scrollTo({top:0,behavior:"smooth"})})),s("k0BvV"),s("jIdqr")}();
//# sourceMappingURL=index.7b09ce5b.js.map
