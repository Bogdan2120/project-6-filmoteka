function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},i=t.parcelRequired7c6;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var i={id:e,exports:{}};return r[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=new Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){n[e]=t},t.parcelRequired7c6=i),i.register("kyEFX",(function(t,r){var n,i;e(t.exports,"register",(function(){return n}),(function(e){return n=e})),e(t.exports,"resolve",(function(){return i}),(function(e){return i=e}));var s={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)s[t[r]]=e[t[r]]},i=function(e){var t=s[e];if(null==t)throw new Error("Could not resolve bundle with id "+e);return t}})),i.register("3Mn9Y",(function(e,t){e.exports=import("./"+i("kyEFX").resolve("fybmk")).then((()=>i("1VOaQ")))})),i("kyEFX").register(JSON.parse('{"5ZPII":"index.7297634b.js","fybmk":"teamModal.046e9029.js"}'));var s,o,a,c=s={};function u(){throw new Error("setTimeout has not been defined")}function l(){throw new Error("clearTimeout has not been defined")}function h(e){if(o===setTimeout)return setTimeout(e,0);if((o===u||!o)&&setTimeout)return o=setTimeout,setTimeout(e,0);try{return o(e,0)}catch(t){try{return o.call(null,e,0)}catch(t){return o.call(this,e,0)}}}!function(){try{o="function"==typeof setTimeout?setTimeout:u}catch(e){o=u}try{a="function"==typeof clearTimeout?clearTimeout:l}catch(e){a=l}}();var d,p=[],f=!1,g=-1;function m(){f&&d&&(f=!1,d.length?p=d.concat(p):g=-1,p.length&&v())}function v(){if(!f){var e=h(m);f=!0;for(var t=p.length;t;){for(d=p,p=[];++g<t;)d&&d[g].run();g=-1,t=p.length}d=null,f=!1,function(e){if(a===clearTimeout)return clearTimeout(e);if((a===l||!a)&&clearTimeout)return a=clearTimeout,clearTimeout(e);try{a(e)}catch(t){try{return a.call(null,e)}catch(t){return a.call(this,e)}}}(e)}}function _(e,t){this.fun=e,this.array=t}function y(){}c.nextTick=function(e){var t=new Array(arguments.length-1);if(arguments.length>1)for(var r=1;r<arguments.length;r++)t[r-1]=arguments[r];p.push(new _(e,t)),1!==p.length||f||h(v)},_.prototype.run=function(){this.fun.apply(null,this.array)},c.title="browser",c.browser=!0,c.env={},c.argv=[],c.version="",c.versions={},c.on=y,c.addListener=y,c.once=y,c.off=y,c.removeListener=y,c.removeAllListeners=y,c.emit=y,c.prependListener=y,c.prependOnceListener=y,c.listeners=function(e){return[]},c.binding=function(e){throw new Error("process.binding is not supported")},c.cwd=function(){return"/"},c.chdir=function(e){throw new Error("process.chdir is not supported")},c.umask=function(){return 0};
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function It(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Et(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(wt(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Ot(t))return"Blackberry";if(Rt(t))return"Webos";if(Tt(t))return"Safari";if((t.includes("chrome/")||kt(t))&&!t.includes("edge/"))return"Chrome";if(St(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=e.match(t);if(2===(null==r?void 0:r.length))return r[1]}return"Other"}function wt(e=k()){return/firefox\//i.test(e)}function Tt(e=k()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function kt(e=k()){return/crios\//i.test(e)}function Et(e=k()){return/iemobile/i.test(e)}function St(e=k()){return/android/i.test(e)}function Ot(e=k()){return/blackberry/i.test(e)}function Rt(e=k()){return/webos/i.test(e)}function Nt(e=k()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function At(){return S()&&10===document.documentMode}function Ct(e=k()){return Nt(e)||St(e)||Rt(e)||Ot(e)||/windows phone/i.test(e)||Et(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ft(e,t){return tt(e,"POST","/v1/accounts:update",t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(o,t),o})(r,n)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,r)=>{e.getProvider("auth-internal").initialize()}))),ye(new V("auth-internal",(e=>{const t=Mt(e.getProvider("auth").getImmediate());return new Nr(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Ie("@firebase/auth","0.21.0",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Ar)),Ie("@firebase/auth","0.21.0","esm2017");firebase.initializeApp({apiKey:"AIzaSyCUNUISB4BvcdddHlHx25A-P_y0LZzRomY",authDomain:"filmoteka-auth-a4ede.firebaseapp.com",projectId:"filmoteka-auth-a4ede",storageBucket:"filmoteka-auth-a4ede.appspot.com",messagingSenderId:"560359018182",appId:"1:560359018182:web:a6a1195c4f88a57c7011c7"});document.getElementById("signin").addEventListener("click",(function(){const e=new firebase.auth.GoogleAuthProvider;firebase.auth().signInWithPopup(e).then((function(e){document.getElementById("signin").classList.add("signOut"),document.getElementById("signout").classList.add("signIn"),document.getElementById("googleUser").style.display="block",function(e){document.getElementById("googleUser").innerHTML=`\n          <img class="user-img" src="${e.user.photoURL}">\n        `}(e)})).catch((function(e){console.log(e)}))})),document.getElementById("signout").addEventListener("click",(function(){firebase.auth().signOut().then((()=>{document.getElementById("signin").classList.remove("signOut"),document.getElementById("signout").classList.remove("signIn"),document.getElementById("googleUser").style.display="none"})).catch((e=>{console.log(e)}))})),new Jt;i("3Mn9Y");
//# sourceMappingURL=index.7297634b.js.map
