 ...
 * limitations under the License.
 */
function O(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function S(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}function R(){const e=O();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}function A(){try{return"object"==typeof indexedDB}catch(e){return!1}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Et(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(St(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(It(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(At(t))return"Blackberry";if(kt(t))return"Webos";if(Tt(t))return"Safari";if((t.includes("chrome/")||Ot(t))&&!t.includes("edge/"))return"Chrome";if(Rt(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=e.match(t);if(2===(null==r?void 0:r.length))return r[1]}return"Other"}function It(e=O()){return/firefox\//i.test(e)}function Tt(e=O()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Ot(e=O()){return/crios\//i.test(e)}function St(e=O()){return/iemobile/i.test(e)}function Rt(e=O()){return/android/i.test(e)}function At(e=O()){return/blackberry/i.test(e)}function kt(e=O()){return/webos/i.test(e)}function Nt(e=O()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Ct(){return R()&&10===document.documentMode}function Lt(e=O()){return Nt(e)||Rt(e)||kt(e)||At(e)||/windows phone/i.test(e)||St(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=index.1b8b26c0.js.map
