 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Xt;Xt="",xt(new J("platform-logger",(t=>new kt(t)),"PRIVATE")),xt(new J("heartbeat",(t=>new Wt(t)),"PRIVATE")),Ft(It,Tt,Xt),Ft(It,Tt,"esm2017"),Ft("fire-js","");
/**
 * @license
